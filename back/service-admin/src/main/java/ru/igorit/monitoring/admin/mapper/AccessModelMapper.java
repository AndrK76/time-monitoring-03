...
public interface AccessModelMapper {

    OrganizationListDto toListDto(AppOrganization organization);
    ...
    AppOrganization fromListDto(OrganizationListDto dto);

    @Mapping(target = "users", source = "users", qualifiedByName = "userOrganizationsToIdsArray")
    OrganizationItemDto toItemDto(AppOrganization organization);
    ...
    default Set<String> toUserIds(AppOrganization organization) {
