package ru.igorit.monitoring.monitoring.listener;
...
import ru.igorit.monitoring.monitoring.service.DictEventsReceiveService;
...
public class RabbitCommandListener {
    ...
    private final DictEventsReceiveService dictService;
            ...
            switch (CommandMessageType.valueOf(command.getCommandType())) {
                case ORGANIZATION_INFO_CHANGED:
                    ...
                    if (orgEvent != null) {
                        ...
                        dictService.applyOrgEvent(orgEvent,command.getUserContext(),command.getSourceService());
                    }
                    break;
