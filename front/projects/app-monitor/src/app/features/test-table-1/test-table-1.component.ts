...
export class TestTable1Component implements OnInit, AfterViewInit {
  ...
  private _filterConfig: Map<string, TableFilterInfo> = new Map<string, TableFilterInfo>([
  ...
  private doSelect = (item: EventRow | undefined, newState: boolean, updateUrl: boolean = true, scrollTo: boolean = false) => {
    this.tableManager.doSelectBaseWithoutCollapse(item, newState, () => this.table.renderRows(), updateUrl, scrollTo, undefined, undefined);
  }
